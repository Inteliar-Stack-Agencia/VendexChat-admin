-- Migration: Fix update_my_store RPC to include sliders and popups
-- The previous version (016) was missing sliders and popups columns,
-- causing those fields to be silently dropped when the RPC fallback was used.
