...
export const productsApi = {
    list: async (params?: { page?: number; limit?: number; search?: string; category_id?: number | string }) => {
        ...
        let query = supabase.from('products').select('id, name, description, price, cost_price, image_url, stock, unlimited_stock, is_active, category_id, sort_order, store_id, is_featured, show_in_store, track_pos_sales, created_at, categories(name)', { count: 'estimated' }).eq('store_id', storeId)
