...
export const billingApi = {
    getPlans: async (): Promise<any[]> => {
        return [
            ...
            { id: 'pro', name: 'Premium (Pro)', description: 'Todo lo que necesitás para crecer y vender más.', price: 9.99, annual_price: 99.90, features: ['Categorías Ilimitadas', 'Productos Ilimitados', 'Dominios Personalizados', 'Estadísticas de Venta', 'Exportar a Excel'], is_popular: true },
            { id: 'vip', name: 'VIP (Business)', description: 'Automatizá tu operación con IA, logística y soporte dedicado.', price: 14.99, annual_price: 149.90, features: ['Todo lo del plan Pro', 'VENDEx Bot con IA', 'Logística Integrada', 'Control de Stock Avanzado', 'Soporte Prioritario'] },
