...
export const billingApi = {
    getPlans: async (): Promise<any[]> => {
        return [
            ...
            { id: 'pro', name: 'PRO', description: 'Todo lo que necesitás para crecer y vender más. Incluye Asistente de Ventas IA.', price: 9.99, annual_price: 99.90, features: ['Categorías Ilimitadas', 'Productos Ilimitados', 'Dominios Personalizados', 'Estadísticas de Venta', 'Importador de Productos con IA'], is_popular: true },
            { id: 'vip', name: 'VIP', description: 'Automatizá tu operación con IA, logística y soporte dedicado.', price: 14.99, annual_price: 149.90, features: ['Todo lo del plan Pro', 'VENDEx Bot con IA', 'Logística Integrada', 'CRM con IA & Analítica', 'Soporte Prioritario'] },
