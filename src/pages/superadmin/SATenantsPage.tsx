...
import { Search, Filter, MoreHorizontal, Store, CheckCircle, Clock, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    return (
        <div className="space-y-8">
            <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button className="bg-indigo-600 text-white font-bold px-6 py-3 rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-100 shrink-0">
                    + Nueva Tienda Manual
                </button>
            </header>
